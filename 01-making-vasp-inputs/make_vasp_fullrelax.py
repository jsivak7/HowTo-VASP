...
struct = read('./01_making_inputs/NiO_2x2x2.cif')

# nomenclature for files
name = 'relax_NiO_2x2x2' # this is for the file where vasp files will be placed
abbrev_name = 'NiO_64_relax' # this is for the qsub submission to ACI
